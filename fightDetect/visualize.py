...
if __name__ == '__main__':
    ...
    plotly.offline.plot(fig, filename='fightDetect/fig/' + src_name + '-left-hand.html')

    # 15. left ankle: 45-x, 46-y, 47-confidence
    fig = px.scatter_3d(keys, x='45', y='46', z='image_id', color='47', symbol='idx')
    plotly.offline.plot(fig, filename='fightDetect/fig/' + src_name + '-left-ankle.html')
    ...
    plotly.offline.plot(fig, filename='fightDetect/fig/' + src_name + '-left-hand-speed.html')

    fig = px.scatter_3d(speed[speed['47'] > 0.5], x='45', y='46', z='image_id', color='47_speed', symbol='idx')
    plotly.offline.plot(fig, filename='fightDetect/fig/' + src_name + '-left-ankle-speed.html')
